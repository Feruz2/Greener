...
function Footer() {
  return (
    <footer className="relative w-full bg-black">
      <div className="py-8 mx-auto w-full max-w-7xl px-8">
            ...
            <div className="col-span-1">
              {LINKS.map(({ title, items, links }) => (
                <ul key={title}>
                  <Typography
                    color="white"
                    className="mb-3 font- poppins font-semibold"
                  >
                    {title}
                  </Typography>
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          <Typography
            variant="small"
            className="mb-4 text-center font-light text-white font-poppins md:mb-0 opacity-80"
          >
            &copy; {currentYear} <a href="/">Greener</a>. All Rights Reserved.
          </Typography>
